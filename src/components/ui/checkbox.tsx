  ...
  return (
    ...
    >
      ...
      >
        <rect
          ...
          className={cn(
            ...
            // hover
            'group-hover/checkbox:group-data-[state=checked]/checkbox:fill-bg-strong-950',
            'group-hover/checkbox:group-data-[state=indeterminate]/checkbox:fill-bg-strong-950',
            // focus
      ...
      >
        <IconCheck
          className={cn(
            'absolute left-1/2 top-1/2 shrink-0 -translate-x-1/2 -translate-y-1/2 opacity-0 transition-opacity duration-200',
            // checked
        ...
        <IconIndeterminate
          className={cn(
            ...
            'group-data-[state=checked]/checkbox:invisible',
          )}
        />
      </CheckboxPrimitive.Indicator>
    </CheckboxPrimitive.Root>
